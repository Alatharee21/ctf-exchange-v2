...
OUTPUT="$(forge script ExchangeDeployment \
    ...
    -s "deployNrExchange(address,address,address,address,address,address,address)" $ADMIN $COLLATERAL $CTF $NEG_RISK_ADAPTER $PROXY_FACTORY $SAFE_FACTORY $FEE_RECEIVER)"
